...
def test_item_reset():
    item = Item(path="/test/path.txt", type=ItemType.SLIDE, md5sum="hash123", cached=True)
...
def test_item_equality():
    ...
    item2 = Item(path="/path2.txt", type=ItemType.SCRIPT, md5sum="hash123")  # Different path/type
    item3 = Item(path="/path3.txt", type=ItemType.SLIDE, md5sum="hash456")  # Different hash
...
def test_item_equality_with_extra():
    item1 = Item(path="/path1.txt", type=ItemType.SLIDE, md5sum="hash123", extra={"key": "value"})
    item2 = Item(path="/path2.txt", type=ItemType.SLIDE, md5sum="hash123", extra={"key": "value"})
    item3 = Item(path="/path3.txt", type=ItemType.SLIDE, md5sum="hash123", extra={"key": "other"})
...
def test_item_cache():
    item = Item(path="/test/path.txt", type=ItemType.SLIDE, md5sum="hash123", cached=False)
