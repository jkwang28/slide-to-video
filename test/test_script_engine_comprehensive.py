...
def test_split_script_with_custom_marker(script_engine, tmp_path):
    ...
    result = script_engine.split_script(str(script_path), str(output_dir), marker="CUSTOM")
...
def test_split_script_with_replace_dict(script_engine, tmp_path):
    ...
    result = script_engine.split_script(str(script_path), str(output_dir), script_dict=replace_dict)
