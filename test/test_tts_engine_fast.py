...
from src.slide_to_video.tts_engine.registery import register_engine, get_all_engine_names, create_engine
...
def test_par_synthesize_parallel(mock_futures):
    ...
    mock_executor = Mock()
    mock_futures.ThreadPoolExecutor.return_value.__enter__ = Mock(return_value=mock_executor)
