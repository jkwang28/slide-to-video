...
def test_slide_to_video_existing_dir_no_project_file(mock_system, mock_exists, mock_makedirs, mock_project_class):
    from src.slide_to_video.lib import slide_to_video
...
@patch('src.slide_to_video.lib.os.path.exists')
@patch('src.slide_to_video.lib.os.system')
def test_slide_to_video_existing_dir_with_project_file(mock_system, mock_exists, mock_makedirs, mock_project_class):
    from src.slide_to_video.lib import slide_to_video
...
@patch('src.slide_to_video.lib.os.makedirs')
@patch('src.slide_to_video.lib.os.path.exists')
@patch('builtins.open', new_callable=mock_open, read_data="original: replacement\nkey: value")
def test_slide_to_video_with_script_dict(mock_file, mock_exists, mock_makedirs, mock_project_class):
    from src.slide_to_video.lib import slide_to_video
...
@patch('src.slide_to_video.lib.os.makedirs')
@patch('src.slide_to_video.lib.os.path.exists')
def test_slide_to_video_without_script_dict(mock_exists, mock_makedirs, mock_project_class):
    from src.slide_to_video.lib import slide_to_video
