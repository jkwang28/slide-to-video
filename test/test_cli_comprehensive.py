...
def test_generate_config_file_empty(mock_yaml, mock_open, mock_project_config, mock_slide_to_video):
...
@patch('builtins.open')
@patch('src.script.yaml.safe_load')
def test_generate_config_file_partial_override(mock_yaml, mock_open, mock_project_config, mock_slide_to_video):
    ...
    result = runner.invoke(app, [
        ...
        '--output-dir', '/output',
        '--config', 'partial.yaml',
        '--delay', '3.5'  # This should override any config file value
    ])
