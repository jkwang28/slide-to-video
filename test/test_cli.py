...
def test_generate_basic_local(mock_yaml, mock_open, mock_project_config, mock_slide_to_video):
    # Mock ProjectConfig
...
@patch('builtins.open')
@patch('src.script.yaml.safe_load')
def test_generate_with_config_file(mock_yaml, mock_open, mock_project_config, mock_slide_to_video):
    ...
    result = runner.invoke(app, [
        '--model', 'local',  # Use valid model name
        '--slide', 'test.pdf',  # Required parameter
        '--script', 'test.txt',
        '--output-dir', '/output',
        '--config', 'config.yaml'
    ])
...
def test_generate_valid_languages(mock_project_config, mock_slide_to_video):
    ...
    valid_languages = ['en', 'es', 'fr', 'de', 'it', 'pt', 'pl', 'tr', 'ru', 'nl', 'cs', 'ar', 'zh-cn', 'hu', 'ko', 'ja', 'hi']
...
@patch('builtins.open')
@patch('src.script.yaml.safe_load')
def test_generate_config_file_overrides_defaults(mock_yaml, mock_open, mock_project_config, mock_slide_to_video):
...
@patch('builtins.open')
@patch('src.script.yaml.safe_load')
def test_generate_empty_config_file(mock_yaml, mock_open, mock_project_config, mock_slide_to_video):
